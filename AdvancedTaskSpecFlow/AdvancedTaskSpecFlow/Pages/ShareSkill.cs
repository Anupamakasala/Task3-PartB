...
namespace AdvancedTaskSpecFlow.Pages
{
    public class ShareSkill:CommonDriver
    {
        ...
        {
            WaitHelpers.WaitToExist(driver, "XPath", "//a[@class='ui basic green button']", 10);
                                    ...
                                    string active)
        {
            ...
            Thread.Sleep(3000);
            //WaitHelpers.WaitToExist(driver,"Name", "subcategoryId", 6);
            ...
            WaitHelpers.WaitToExist(driver, "XPath", "//input[@type='button'and@value='Save']", 5);
            save.Click();
        }
        ...
        public string GetManageListing()
        {
            ...
            WaitHelpers.WaitToExist(driver, "XPath", "//div[2]/div[1]/div[1]/table/tbody/tr[1]/td[3]", 10);
