...
namespace AdvancedTaskSpecFlow
{
    ...
    public class FeatureFileStepDefinitions : CommonDriver
    {
        ...
        public void ThenAllTheNotificationsDisplayedOnThePage()
        {
            ...
            string TextButton = notificationObj.GetShowLessText();
            Assert.That(TextButton == "...Show Less", "Failed");
        ...
        {
            string TextButton = notificationObj.GetLoadMoreText();
            Assert.That(TextButton == "Load More...", "Failed");
